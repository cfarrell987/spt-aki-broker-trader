namespace BrokerTraderPlugin
{
    ...
    {
        // Broker Trader routes
        public const string PostSoldItemsData = "/broker-trader/post/sold-items-data";
        public const string GetModConfig = "/broker-trader/get/mod-config";
